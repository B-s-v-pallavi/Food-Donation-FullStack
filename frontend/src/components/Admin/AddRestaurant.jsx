...
const AddRestaurant = () => {
  ...
  const handleSubmit =  (e) => {
    ...
    const restaurantData = { ...restaurant, availableFoodItems: foodItems };
     ...
     axios
      .post(`${import.meta.env.VITE_BACKEND_API}/api/restaurant`, restaurantData, {
  ...
  return (
    <div className="add-restaurant-container">
      <h1 class="head1">Restaurant Registration</h1>
      <form className="add-restaurant-form" onSubmit={handleSubmit}>
        ...
        <h3 class="head2">Available Food Items</h3>
        <div className="form-group food-item-input">
          ...
          <input
            ...
            onChange={handleFoodItemChange}
          />
          <button type="button" onClick={addFoodItem} class="bt">
            Add Food Item
          </button>
        </div>
        {foodItems.length > 0 && (
      ...
      <button className="but" onClick={handleBack}>
        Back
      </button>
    </div>
  );
